...
@RestController
@RequestMapping("/api/data-collector-io-t-kafka")
public class DataCollectorIoTKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DataCollectorIoTKafkaResource.class);
    ...
    public DataCollectorIoTKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
